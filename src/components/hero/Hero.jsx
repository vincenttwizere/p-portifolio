...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative min-h-[calc(100vh-6rem)] md:min-h-screen bg-gradient-to-b from-white to-gray-100 dark:from-gray-900 dark:to-gray-800 pt-6 pb-4 md:py-12 lg:py-16">
      {/* 3D Background */}
      ...
      <div className="relative z-10 h-full flex items-center">
        <div className="w-full px-4">
          <div className="max-w-[90rem] mx-auto grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            {/* Text Content */}
            <motion.div
